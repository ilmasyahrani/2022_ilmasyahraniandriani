...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nim && $nama && $alamat && $prodi && $jeniskelamin && $agama) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update mahasiswa set nim = '$nim',nama='$nama',alamat = '$alamat',prodi='$prodi',jeniskelamin='$jeniskelamin', agama='$agama' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into mahasiswa(nim,nama,alamat,prodi,jeniskelamin,agama) values ('$nim','$nama','$alamat','$prodi','$jeniskelamin','$agama')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="prodi" id="prodi">
                                ...
                                <option value="INDUSTRI" <?php if ($prodi == "INDUSTRI") echo "selected" ?>>INDUSTRI</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
